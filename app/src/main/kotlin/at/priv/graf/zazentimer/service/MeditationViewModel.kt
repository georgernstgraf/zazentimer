...
class MeditationViewModel @Inject constructor(
    ...
    fun bindToService(app: Application, h: Handler, callback: Runnable) {
        this.handler = h
    ...
    fun startMeditation(app: Application, sessionId: Int) {
        ...
        bindToService(app, this.handler ?: Handler(Looper.getMainLooper()), Runnable {
    ...
    private fun pollMeditationState() {
        ...
        if (!this.timerViewInitialized) {
            ...
            val initState = MeditationUiState(
                0,
    ...
    fun acquireScreenWakeLock(app: Application, pref: SharedPreferences) {
