...
object BellCollection {
    ...
    fun initialize(context: Context) {
        ...
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.bell1),
                context.resources.getString(R.string.bell_name_1),
            ),
        )
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.bell2),
                context.resources.getString(R.string.bell_name_2),
            ),
        )
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.dharma107),
                context.resources.getString(R.string.bell_name_3),
            ),
        )
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.dharmaschwarz88),
                context.resources.getString(R.string.bell_name_4),
            ),
        )
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.shomyo90),
                context.resources.getString(R.string.bell_name_5),
            ),
        )
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.tang164),
                context.resources.getString(R.string.bell_name_6),
            ),
        )
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.tib230),
                context.resources.getString(R.string.bell_name_7),
            ),
        )
        this.bells.add(
            Bell(
                getPredefinedBellUri(context, R.raw.zen97),
                context.resources.getString(R.string.bell_name_8),
            ),
        )
        loadCustomBells(context)
    }

    private fun loadCustomBells(context: Context) {
        val listFiles =
            context.filesDir.listFiles(
                FilenameFilter { _: File, str: String -> str.startsWith("bell_") },
            )
        if (listFiles != null) {
