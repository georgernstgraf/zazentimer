...
public class TimerView extends View {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        setOnClickListener(new View.OnClickListener() { // from class: at.priv.graf.zazentimer.views.TimerView.1
    ...
    public void setSectionNames(final String str, final String str2, String str3) {
        if (((str.equals(this.currentSectionName) && str2.equals(this.nextSectionName)) ? false : true) && this.runningAnims.get(6) == null) {
            ...
            animateTo(6, 1, 1400, new Runnable() { // from class: at.priv.graf.zazentimer.views.TimerView.2
                @Override // java.lang.Runnable
                public void run() {
