...
public class MessageView {
    ...
    public void show() {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: at.priv.graf.zazentimer.MessageView.1
            ...
            public void onClick(View view) {
                ...
                objectAnimator2.addListener(new Animator.AnimatorListener() { // from class: at.priv.graf.zazentimer.MessageView.1.1
