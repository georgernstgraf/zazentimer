...
public class TimePickerFragment extends androidx.fragment.app.DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: at.priv.graf.fragments.TimePickerFragment.1
        ...
        builder.setNegativeButton(R.string.abbrechen, new DialogInterface.OnClickListener() { // from class: at.priv.graf.fragments.TimePickerFragment.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
            }
        });
