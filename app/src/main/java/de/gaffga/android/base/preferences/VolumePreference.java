...
public class VolumePreference extends DialogPreference {
    ...
    protected View onCreateDialogView() {
        ...
        this.audio = new Audio(getContext());
        this.curMainVolume = this.audio.getStreamVolume();
        this.seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: de.gaffga.android.base.preferences.VolumePreference.1
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                VolumePreference.this.audio.playAbsVolume(BellCollection.getInstance().getDemoBell(), 100, seekBar.getProgress());
            }

            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                VolumePreference.this.currentValue = i;
                textView.setText(i + "%");
            }
        });
        this.seekBar.setProgress(this.currentValue);
