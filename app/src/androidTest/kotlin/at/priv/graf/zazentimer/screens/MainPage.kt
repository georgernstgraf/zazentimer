...
class MainPage : BasePage() {
    ...
    fun verifySessionSelected(position: Int): MainPage {
        ...
        onView(withId(R.id.recycler_sessions))
            .perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(position, object : androidx.test.espresso.ViewAction {
    ...
    fun clickSessionOverflowAtPosition(position: Int): MainPage {
        onView(withId(R.id.recycler_sessions))
            .perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(position, clickChildViewWithId(R.id.sessionOverflow)))
        SystemClock.sleep(500)
        return this
    }

    fun clickSessionOverflowAction(position: Int, textResId: Int): MainPage {
