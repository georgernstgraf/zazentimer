...
| **Add Session via Menu** | Open toolbar overflow menu -> "Add Session" | Navigates to Edit Session screen for new session | #37/#42 Fixed: menu_add_session added to main_menu.xml, wired to onFabNewSessionClicked() | 🟢 |
...
| **Screen Lock** | Let device sleep during meditation | Meditation continues; notification is visible | WakeLock / FGS issues | 🔴 Skipped - too complex/flaky for automated testing |
| **Section Transition** | Wait for one section to end | Bell plays; timer switches to next section | | 🔴 Skipped - too complex/flaky for automated testing |
